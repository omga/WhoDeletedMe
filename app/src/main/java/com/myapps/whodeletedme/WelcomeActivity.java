...
import com.myapps.whodeletedme.view.kbv.KenBurnsView;
            ...
            ParseFacebookUtils.logInWithReadPermissionsInBackground(
                WelcomeActivity.this, permissions, new LogInCallback() {
                    ...
                    public void done(ParseUser user, ParseException err) {
                        FacebookDataFetcher dataFetcher = new FacebookDataFetcher(WelcomeActivity.this);
                        if (user == null) {
                            ...
                            dataFetcher.getUserInfo((User) user);
